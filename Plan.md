> [!NOTE]
> Я хотел бы посвятить в linux, расказть о сетях. Про микроконтролеры и про ADB/FastBoot 
>
> Уроки не были включены в курс из за не имением ресурсов, полное погружение в тему выходит за рамки закона или приводит к ожирению   
...
# Как работают комплектующие компьютера
...
- можно расказать почему компы греются
...
### OpenServer
> [!WARNING]  
> Этот урок не закончен!
- Скачеваем и устанавливаем OpenServer
- Настраиаваем
- Хостим WP
...
- Скачиваем образ
- - Выбрать флешку в поле «Устройство»  
- - Нажать Выбрать и указать образ 
- - Выбрать схему разделов  
- - Нажать Старт и подтвердить начало записи  
...
### 
> [!CAUTION]
> Этот урок даже не знает кто он!
