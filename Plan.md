> [!NOTE]
> Я хотел бы посвятить в linux, расказть о сетях. Про микроконтролеры и про ADB/FastBoot.Геймдизайн Godot Engine

# Урок 1
### Создаем первый сайт
-Расказываем как работают сайты и домены 

![Как работаютсайты](/lesson1_1.jpg)
...
- - Cyr-To-Lat
- - Rank Math SEO
- - WPCode Lite --он понадобился перелапачивать код темы когда она сломалась совсем не в кайф
- - WPS Hide Login
